...
# Created Time: 07/15/14 15:23:49 (CST)
# Modified Time: 07/15/14 16:03:54 (CST)
...
if __name__ == '__main__':
   ...
   suiteFew.addTest(TestInvestment("test_simple"))

   suiteFew.addTest(TestInvestment("test_zero_principal"))
